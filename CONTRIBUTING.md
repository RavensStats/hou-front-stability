...
- Tests: `python tests/test_ivmat.py` runs standalone (no pytest) and exercises the verified interval-matrix layer behind Theorems 1 and 2, negative controls included; add one for any new solver.
