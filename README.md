...
`paper/NOTE_KNSS.md`, `paper/COMMENT_FOCM.md` and `paper/PAPER_DRAFT.md` are **superseded**. The note and the comment were withdrawn as standalone pieces and folded into Section 6 of the paper; the draft carries an earlier title and an incomplete author block. They are kept for the record, not as companions, and should not be cited.
